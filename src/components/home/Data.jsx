...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__tittle">Shantanu Vidhate
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm Full Stack Developer based in Florida , I'm very passionate and deddicated to my work</p>
