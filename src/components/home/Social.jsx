...
const Social = () => {
  return (
    <div className="home__social">
      <a href="https://www.linkedin.com/in/shantanu-vidhate-3077711a0/" className="home__social-icon" target="_blank" rel="noreferrer">
      <LinkedInIcon />
      </a>
      
      <a href="https://github.com/shantanuvidhate" className="home__social-icon" target="_blank" rel="noreferrer">
      <GitHubIcon />
      </a>

      <a href="https://shantanuvidhate.hashnode.dev/" className="home__social-icon" target="_blank" rel="noreferrer">
